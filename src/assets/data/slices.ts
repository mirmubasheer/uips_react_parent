const SECTORS = [
    ...
    { label: "Power House", link: "/power" },
    { label: "Shutdowns", link: "/shutdowns" },
    { label: "Sale Gas Division", link: "/mechanical" },
    { label: "UG Cabling", link: "/electrical" },
    { label: "Port Division", link: "/civil" },
  ];
